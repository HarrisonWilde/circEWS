...
MIMIC_PIDS_PATH = "/data/harry/mimiciii/validation/external_validation/endpoints/181103/reduced"
OUT_PATH = "/data/harry/mimiciii/validation/external_validation"
...
print("Wrote {} pids to {}".format(len(pids), os.path.join(OUT_PATH, "pids_with_endpoint_data.csv.181103")))